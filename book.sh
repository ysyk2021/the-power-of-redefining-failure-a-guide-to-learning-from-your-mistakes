...
ebook-convert the-power-of-redefining-failure-a-guide-to-learning-from-your-mistakes.epub the-power-of-redefining-failure-a-guide-to-learning-from-your-mistakes.docx --no-chapters-in-toc --chapter-mark=none --disable-markup-chapter-headings --docx-no-toc --docx-no-cover --docx-page-size=a5 --extra-css page_styles.css
